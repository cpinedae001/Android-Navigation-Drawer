...
public class ConexionSQLiteHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            db.execSQL("create table guia (no_guia text primary key, fecha text, nomrem text, nomdes text, dirrem text, dirdes text, telrem text, teldes text, entregado text, ruta text , transmitido text )");
